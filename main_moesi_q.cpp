...
unsigned long long Bus, cache_read, mem_write;
#define CORE_COUNT 8
#define PR 'R'
#define PW 'W'
#define I 'I'
...
int q_empty=queue_size,service_time=5;
...
int main(int argc, char **argv)
{
  ...
  cout << " L3 Hit:" << LLC.hitCount << " L3 Miss:" << LLC.missCount << " Bus read:" << Bus << "Cache reads:" << cache_read<<"avg bus wait time:"<<waiting_time/Bus;
}
